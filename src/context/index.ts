...
class Scope implements ScopeDisposable {
  public static readonly global = new Scope(null);
  ...
  public constructor(parent: Scope | null = Scope.global) {
    this._parent = parent;
...
export { Scope, scopeDisposeSymbol, type ScopeDisposable, type Scoped };
